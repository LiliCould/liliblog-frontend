<template>
  <aside class="hidden lg:flex flex-col gap-6 sticky top-24 self-start">
    ...
    >
      ...
      <div class="flex flex-wrap gap-2.5 max-h-[26rem] overflow-y-auto p-1 [&::-webkit-scrollbar]:w-[5px] [&::-webkit-scrollbar-track]:bg-transparent [&::-webkit-scrollbar-thumb]:bg-[rgba(0,240,255,0.15)] [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-thumb:hover]:bg-[rgba(0,240,255,0.3)]">
        <router-link
