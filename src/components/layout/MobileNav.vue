    ...
    <Transition enter-active-class="transition duration-300 ease-out" enter-from-class="translate-x-full"
      ...
      <div v-if="appStore.isMobileNavOpen"
        ...
        <div class="flex items-center justify-between px-5 py-4 border-b border-t-border relative">
          ...
          <button
            class="flex items-center justify-center w-8 h-8 text-t-muted cursor-pointer transition-all duration-200 hover:text-t-primary [filter:hover:drop-shadow(0_0_4px_rgba(var(--color-primary-rgb),0.4))]"
        ...
        <div class="flex-1 py-4 overflow-y-auto">
          ...
          <nav class="flex flex-col">
            ...
            <template v-if="userStore.isLoggedIn">
              ...
              <a class="flex items-center gap-3 px-5 py-3 text-sm text-t-secondary cursor-pointer transition-all duration-200 relative hover:bg-[rgba(var(--color-secondary-rgb),0.08)]"
                @click="handleLogout">
