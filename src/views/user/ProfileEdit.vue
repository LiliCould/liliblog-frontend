  ...
  <AppLayout :show-hero="false">
    <div class="max-w-2xl mx-auto">
      <div class="flex items-center gap-3 mb-6">
        ...
        <h1 class="text-2xl font-bold text-white">编辑资料</h1>
      </div>

      <div class="rounded-xl bg-[#111118] border border-[rgba(0,240,255,0.15)] p-6">
        <div class="flex items-center gap-6 mb-8">
          <div class="relative group">
            <div class="w-24 h-24 rounded-full bg-[#1a1a24] border-2 border-[rgba(0,240,255,0.3)] flex items-center justify-center overflow-hidden">
          ...
          <div>
            <p class="text-sm text-[#e0e0e8]">点击头像更换</p>
        ...
        <div class="flex items-center gap-3">
          <button
            class="flex items-center gap-2 px-5 py-2.5 rounded-lg bg-[rgba(0,240,255,0.1)] border border-[#00f0ff] text-[#00f0ff] text-sm font-medium transition-all duration-300 hover:bg-[rgba(0,240,255,0.2)] hover:shadow-[0_0_12px_rgba(0,240,255,0.2)] cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
            :disabled="saving"
            @click="saveProfile"
          >
            <Save class="w-4 h-4" />
          ...
          <button
            class="px-5 py-2.5 rounded-lg border border-[rgba(0,240,255,0.15)] text-[#6b7280] text-sm font-medium transition-all duration-300 hover:text-[#e0e0e8] hover:border-[rgba(0,240,255,0.3)] cursor-pointer"
            @click="router.back()">
            取消
          </button>
        </div>
