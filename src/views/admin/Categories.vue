        ...
        <table class="w-full text-sm">
          ...
          <tbody>
            <tr v-for="category in categories" :key="category.id"
              ...
              <td class="px-5 py-3.5 text-t-muted">{{ category.articleCount }}</td>
          ...
          <div class="space-y-4">
            ...
            <div>
              ...
              <textarea v-model="form.description" rows="3"
                class="w-full px-3 py-2 rounded-lg bg-t-bg border border-t-border text-t-body text-sm outline-none transition-colors duration-200 focus:border-t-primary resize-none"
...
function debouncedApplyFilters() {
  ...
  debounceTimer = setTimeout(() => loadCategories(1), 1000)
}
