  ...
  <div class="space-y-6">
    ...
    <Teleport to="body">
      <div v-if="showPreview" class="fixed inset-0 z-[1200] flex items-center justify-center">
        ...
        <div
          class="relative w-full max-w-3xl mx-4 max-h-[85vh] rounded-xl bg-t-surface border border-t-border shadow-[0_0_24px_rgba(var(--color-primary-rgb),0.1)] flex flex-col">
