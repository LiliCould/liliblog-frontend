                    ...
                    <tbody>
                        <tr v-for="comment in comments" :key="comment.id"
                            ...
                            <td class="px-5 py-3.5">
                                <div class="flex items-center gap-2">
                                    <div
                                        class="w-7 h-7 rounded-full bg-t-elevated border border-t-border flex items-center justify-center overflow-hidden flex-shrink-0">
                                        <img :src="resolveAvatar(comment.creator?.avatar)" alt=""
